...
const dadosCarrossel = [
  {
    ...
    unidade: "Bloco A",
    andar: "Terreo",
    superiores: [{ id: 1, nome: "Sala1" }, { id: 2, nome: "sala2" }, { id: 3, nome: "sala3" }, { id: 4, nome: "sala4" }],
    inferiores: [{ id: 5, nome: "sala5" }, { id: 6, nome: "sala6" }, { id: 7, nome: "sala7" }, { id: 8, nome: "sala8" }],
  },
  {
    id: 2,
    unidade: "Bloco B",
    andar: "1° Andar",
    superiores: [{ id: 9, nome: "Sala9" }, { id: 10, nome: "sala10" }, { id: 11, nome: "sala11" }, { id: 12, nome: "sala12" }],
    inferiores: [{ id: 13, nome: "sala13" }, { id: 14, nome: "sala14" }, { id: 15, nome: "sala15" }, { id: 16, nome: "sala16" }],
  },
  {
    id: 3,
    unidade: "Bloco B",
...
export default function MapaComponent() {
  ...
  const anterior = () => {
    setPaginaAtual((prev) => (prev - 1 + dadosCarrossel.length) % dadosCarrossel.length)
  }
