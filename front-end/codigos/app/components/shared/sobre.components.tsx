        ...
        <div className="mx-auto max-w-6xl w-full p-6 md:p-12 flex-1 flex flex-col justify-center">
          ...
          <section className="flex flex-col gap-6 w-full">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 items-stretch">
              <div className="flex items-center justify-center rounded-3xl bg-white p-8 text-zinc-700 shadow-sm min-h-[320px] transition-all duration-150 ease-in-out active:scale-[0.98] active:shadow-lg active:brightness-95 touch-manipulation select-none">
              ...
              <div className="relative min-h-[320px] overflow-hidden rounded-3xl bg-white shadow-sm transition-all duration-150 ease-in-out active:scale-[0.98] active:shadow-lg active:brightness-95 touch-manipulation select-none">
                <ImagemComponent nomeImagem="senai-mariano-ferraz.png" alt="Senai Mariano-Ferraz" fill/>
              </div>
            </div>
